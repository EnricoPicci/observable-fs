import { Observable, bindCallback, bindNodeCallback, from } from "rxjs";
...
function _readLines(
  filePath: string,
  callback: (lines: Array<string>) => void
) {
...
const _writeFileObs = bindCallback(_writeFile);
function _writeFile(
  filePath: string,
  lines: Array<string>,
...
const _mkdirp = bindNodeCallback(mkdirp);
